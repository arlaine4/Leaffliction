...
def parse_args():
    ...
    parser.add_argument('-m', default='model/model.h5',
                        action='store_true', help='Model path')
    parser.add_argument('-c', default='model/class_names.txt',
                        action='store_true',
    ...
    """parser.add_argument('-cn', '--class_names', action='store_true',
